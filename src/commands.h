...
class Commands
{
	...
	protected:
		...
		void saveGame(Player& player, const std::string& param);
		void shutdownServer(Player& player, const std::string& param);
		void reloadAll(Player& player, const std::string& param);
